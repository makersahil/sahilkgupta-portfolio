...
const devOpsScenarioDefinitions = [
  {
    ...
    actions: { schemaVersion: 'devops.scenario.v1', mutations: [{ type: 'SET_PIPELINE_STAGE_STATUS', pipelineId: 'delivery', stageId: 'stage-3', status: 'FAILED' }] },
  ...
  },
  {
    ...
    actions: { schemaVersion: 'devops.scenario.v1', mutations: [{ type: 'SET_WORKLOAD_READINESS', name: 'core-api', namespace: null, readyReplicas: 0, status: 'DEGRADED' }] },
    expectedObservations: { observableSignals: ['workload-ready-replicas-below-desired', 'kubernetes-health=DEGRADED'] },
    verificationCriteria: { checks: ['replica mismatch is surfaced by operations analysis', 'no kubectl command is executed by the portfolio runtime'] },
  },
  {
    slug: 'argocd-drift',
    title: 'ArgoCD Drift',
    ...
    actions: { schemaVersion: 'devops.scenario.v1', mutations: [{ type: 'SET_GITOPS_SYNC_STATUS', appName: 'recorded-argocd-reconciliation', syncStatus: 'OUT_OF_SYNC' }] },
  ...
  },
  {
    ...
    actions: { schemaVersion: 'devops.scenario.v1', mutations: [{ type: 'SET_OBSERVATION_STATUS', observationId: 'observation-stage-6', status: 'FAIL' }] },
  ...
  },
  {
    ...
    actions: { schemaVersion: 'devops.scenario.v1', mutations: [{ type: 'SET_NETWORK_POLICY_STATUS', policyName: 'recorded-cilium-network-policies', namespace: null, status: 'UNKNOWN' }] },
  ...
  const tracks = [
    {
      ...
      description: 'Routing and switching curriculum reference. Individual objective progress is not tracked by this portfolio.',
      totalObjectives: 0,
    ...
    },
    {
      ...
      domain: Domain.LINUX,
      description: 'Linux systems administration curriculum reference. Individual objective progress is not tracked by this portfolio.',
      totalObjectives: 0,
      completedObjectives: 0,
    },
    {
      ...
      description: 'Containers, pipelines, and infrastructure-as-code curriculum reference. Individual objective progress is not tracked by this portfolio.',
      totalObjectives: 0,
      completedObjectives: 0,
    },
  ];

      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-7 flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-relaxed text-white/55">Inspect persisted CI/CD, infrastructure-as-code, Kubernetes, GitOps and observability snapshots from canonical Lab manifests. Only modules actually represented by the selected Lab are rendered.</p>
          </div>
